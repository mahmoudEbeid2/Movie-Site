    ...
    <div className="container-fluid mx-auto p-4 md:p-8">
      <main className="flex flex-col gap-8 items-center">
        <div className="bg-[#F3F1F1] w-full p-4 ">
          ...
          <p className="text-sm font-normal my-4">Millions of movies, TV shows and people to discover. Explore now.</p>
          <SearchForm/>
        </div>
        <h3 className="text-lg m-0 w-full font-bold text-start">
          Now Playing
        </h3>
